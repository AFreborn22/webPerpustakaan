...
@section('konten')
    <div class="height-100">
        ...
        <h4 class="home_page" style="text-align: center">Selamat Datang di Halaman Dashboard Dosen dan Pegawai</h4>


    </div>
    <br /><br />

    <button class="button-popup" id="button-popup" style="{{ $lastStatus === 'Dipinjam' ? 'display:none;' : 'visibility:visible;' }}">
    ...
    <div class="popup" id="popup">
        <div class="popup-content">
            ...
            <br><br>
            <h6><b>NIK Peminjam</b></h6>
            <h6 id="nik">{{ session('nik') }}</h6>
            <h6><b>Judul</b></h6>
