...
<h2 class="home_page"><b>DATA STAFF</b></h2>
<a href="/admin/tambahStaff">
    <button class="btn btn-warning text-white mt-2 mb-4"><b>Tambah Staff</b></button>
</a>
    <div class="mb-3">
      ...
      <form>
        <div class="form-row">
          <div class="rounded col-md-12 mb-3 d-flex align-items-center justify-content-between">
            <form action="/admin/dataStaff" method="GET">
                <input type="search" class="form-control mx-2 border-2" id="inputCari" name="search" placeholder="Cari Staff...">
    ...
    <table class="table table-bordered text-white rounded-table mt-5" style="background: #3A0561">
        <thead>
            <tr class="text-center">
                ...
                <th class="py-2" style="width: 60%;">Nama Staff</th>
        ...
        <tbody>
            <tr class="text-center">
                ...
                <td class="py-1">{{ $ds->NIK_Staff }}</td>
                <td class="py-1">{{ $ds->Nama }}</td>
                <td class="py-1 justify-content-between">
                    <div class="d-flex justify-content-between">
                        <a href="/admin/{{ $ds->NIK_Staff }}/editStaff">
                            <button class="btn btn-primary btn-sm mx-3">Edit</button>
                        </a>
                        <form action="/admin/{{ $ds->NIK_Staff }}/destroy" method="POST" onsubmit="return confirmDelete(event)">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-danger btn-sm mx-3">Hapus</button>
                        </form>
                    </div>
                </td>
            </tr>
