      ...
      <form>
        <div class="form-row">
          <div class="rounded col-md-12 mb-3 d-flex align-items-center justify-content-between">
            <form action="/admin/dataDosen" method="GET">
            ...
            <tr class="text-center">
                ...
                <td class="py-1 justify-content-between">
                    <div class="d-flex justify-content-between">
                        <a href="/admin/{{ $dd->NIK_dosen }}/editDosen">
                            <button class="btn btn-primary btn-sm mx-4">Edit</button>
                        </a>
                        <form action="/admin/{{ $dd->NIK_dosen }}/destroyDosen" method="POST" onsubmit="return confirmDelete(event)">
                            @csrf
                            @method('DELETE')
