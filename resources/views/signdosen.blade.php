    ...
    <div class="container">
        ...
        @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" id="NIK_dosen" name="NIK_dosen" placeholder="masukkan nik" required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" id="nama_dosen" name="nama_dosen" placeholder="masukkan nama" required>
          </div>
