    ...
    <div style="border-left: 2px solid black; display: inline-block; margin-left: 30px;">
      <div class="userprofile">
        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          </svg> <span id="username" class="username">Admin</span>
        </a>

        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="EditProfilStaff.html">Edit Profil</a></li>
          <li><a class="dropdown-item" href="/editProfil/admin">Setting</a></li>
          <li>
            <hr class="dropdown-divider">
          </li>
          <li><a class="dropdown-item" href="login.html"> <i class="bx bx-log-out nav_icon" style="color: red;">
    ...
    <nav class="nav">
      <div>
        ...
        <div class="nav_list">
          ...
          <a href="/dashboardAdmin" class="nav_link {{ ($title === "Dashboard Admin") ? 'active' : ''}}">
          ...
          <a href="/dataStaff" class="nav_link {{ ($title === "Data Staff") ? 'active' : ''}}">
          ...
          <a href="/dataAnggota" class="nav_link {{ ($title === "Data Anggota") ? 'active' : ''}}">
