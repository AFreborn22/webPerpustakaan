        ...
        <div class="col-md-6 mt-4">
            <form action="/staff/storeMahasiswa" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="NIM" placeholder="Masukkan NIM (8 angka)...">
                </div>
                <div class="form-group">
