...
class DataDosenAdminController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.dataDosen', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/tambahDosen')->with('success', 'Data Dosen berhasil disimpan.');
    }
    ...
    public function update(Request $request, $NIK_dosen)
    {
        ...
        return redirect('/admin/dataDosen')->with('success', 'Data Dosen berhasil diupdate.');
    }
    ...
    public function destroy($NIK_dosen)
    {
        ...
        $hapusDosen->delete();
        return redirect('/admin/dataDosen')->with('success', 'Data Dosen berhasil dihapus.');
    }
